...
public class AircraftRepositoryInMemoryTest {
    ...
    void setUp() {
        ...
        repository.add(new CommercialAircraft(1, 0, 0, 0, 0, 0, 0, "Company 1", "Flight 1"));
        repository.add(new CommercialAircraft(2, 0, 0, 0, 0, 0, 0, "Company 2", "Flight 2"));
        repository.add(new CommercialAircraft(3, 0, 0, 0, 0, 0, 0, "Company 3", "Flight 3"));
    }
