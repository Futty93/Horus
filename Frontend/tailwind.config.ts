  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        ...
        "neon-gradient":
          "linear-gradient(45deg, #00ff88 0%, #00d4ff 50%, #b347d9 100%)",
        "radar-gradient":
          "linear-gradient(90deg, rgba(0,255,136,0.1) 0%, rgba(0,212,255,0.1) 100%)",
        "control-gradient":
        ...
        "button-hover-gradient":
          "linear-gradient(135deg, #00d4ff 0%, #b347d9 100%)",
      ...
      keyframes: {
        glow: {
          "0%": {
            "box-shadow":
              "0 0 5px rgba(0, 255, 136, 0.2), 0 0 10px rgba(0, 255, 136, 0.2)",
          },
          "100%": {
            "box-shadow":
