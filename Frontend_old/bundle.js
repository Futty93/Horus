(() => {
  ...
  // Frontend/scripts/api/simulation.ts
  var SimulationManager = class {
    constructor() {
    ...
    async handleSimulationAction(action) {
  ...
  var RadarGame = class {
    ...
    async initializeAtsRouteData() {
      try {
        ...
        console.error("Error loading ATS routes:", error);
      }
    }
    /**
