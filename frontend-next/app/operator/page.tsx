    ...
    <div className="flex h-screen">
      <div className="flex-1 flex">
        {/* <div className="radarArea relative flex-grow">
          <canvas id="radar" className="w-full h-full bg-black"></canvas>
          <canvas id="radar2" className="hidden"></canvas>
        </div> */}
        <RadarCanvas />
          ...
          <div id="settingArea" className="mt-auto">
            <div id="routeInfoDisplaySetting" className="flex flex-col mb-5">
                ...
                <div key={label} className="mb-2">
                  ...
                  <div className="flex flex-col ml-5">
                    <label className="flex items-center">
                      <input type="checkbox" id={`${label}-name`} className="mr-2" />
                      <span>Name</span>
                    </label>
                    <label className="flex items-center">
                      <input type="checkbox" id={`${label}-point`} defaultChecked className="mr-2" />
                      <span>Point</span>
                    </label>
                  </div>
                </div>
              ...
              <label className="flex items-center mb-2">
                <input type="checkbox" id="ats-lower-routes" className="mr-2" />
                <span>ATS Lower Route</span>
              </label>
              <label className="flex items-center mb-2">
                <input type="checkbox" id="rnav-routes" defaultChecked className="mr-2" />
